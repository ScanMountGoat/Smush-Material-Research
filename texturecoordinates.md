# Texture Coordinate Attributes - WIP
Texture coordinates or UV coordinates (often shortened to UVs) map the meshes's vertices to locations on the textures. Most meshes have a map1 attribute for the main layer of textures. Additional texture coordinate attributes allow additional layers to have separate texture layouts and use the limited texture resolution more efficiently. 
