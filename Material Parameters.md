...
| --- | --- | --- | --- |
| 0x98 | CustomVector0 | (0,0,0,0) | Affects alpha testing. X = min texture alpha, YZW = ??? |
...
| 0x9B | CustomVector3 | (1,1,1,1) | Color multiplier for emission color. Used to brighten/darken emissive maps. Values are often higher than 1 to increase bloom. |
...
| 0xA0 | CustomVector8 | (1,1,1,1) | RGB color multiplier for the final color after diffuse, specular, etc. |
| 0xA1 | CustomVector9 | | RGBA? Always (1, 1, 1, 1) or (0.2620026, -0.6427876, -0.7198463, 0). |
| 0xA2 | CustomVector10 | | RGBA? Always (1, 0.8, 0.6, 0). |
| 0xA3 | CustomVector11 | (0,1,0,0) | Used with CustomVector30 to fake subsurface scattering. RGB = SSS color |
| 0xA4 | CustomVector12 | *Unused* | *Unused* |
| 0xA5 | CustomVector13 | (1,1,1,1) | RGB diffuse color multiplier. May also affect alpha. Usually present and set to (1, 1, 1, 1). |
...
| 0xA9 | CustomVector17 | *Unused* | *Unused* |
| 0xAA | CustomVector18 | (1,1,1,1) | Used for sprite sheet animations. X * Y = W if the sprite sheet is full. X = column count, Y = row count, Z = frames per sprite, W = sprite count |
...
| 0x141 | CustomVector26 | *Unused* | *Unused* |
| 0x142 | CustomVector27 | | Controls distance fog. X = Intensity, YZW = ??? |
| 0x143 | CustomVector28 | *Unused* | *Unused* |
...
| 0x145 | CustomVector30 | (0,0,0,1) | Fake SSS using CustomVector11. X = blend factor, Y = diffuse shading smooth factor (higher is sharper), ZW = Unused |
...
| 0x150 | CustomVector41 | *Unused* | *Unused* |
...
| 0x157 | CustomVector48 | *Unused* | *Unused* |
| 0x158 | CustomVector49 | *Unused* | *Unused* |
| 0x159 | CustomVector50 | *Unused* | *Unused* |
| 0x15A | CustomVector51 | *Unused* | *Unused* |
| 0x15B | CustomVector52 | *Unused* | *Unused* |
| 0x15C | CustomVector53 | *Unused* | *Unused* |
| 0x15D | CustomVector54 | *Unused* | *Unused* |
| 0x15E | CustomVector55 | *Unused* | *Unused* |
| 0x15F | CustomVector56 | *Unused* | *Unused* |
| 0x160 | CustomVector57 | *Unused* | *Unused* |
| 0x161 | CustomVector58 | *Unused* | *Unused* |
| 0x162 | CustomVector59 | *Unused* | *Unused* |
| 0x163 | CustomVector60 | *Unused* | *Unused* |
| 0x164 | CustomVector61 | *Unused* | *Unused* |
| 0x165 | CustomVector62 | *Unused* | *Unused* |
| 0x166 | CustomVector63 | *Unused* | *Unused* |
...
| 0x63 | Texture7 | `#replace_cubemap` | *Cube Map* | Specular Cube Map |
...
| 0x6B | Texture15 | *Unused* | *Unused* |  *Unused* |
| 0x133 | Texture16 | | ??? | Ink Normal Map. Used for stage ink meshes. Often uses a default white texture. |
| 0x134 | Texture17 | *Unused* | *Unused* | *Unused* |
| 0x135 | Texture18 | *Unused* | *Unused* | *Unused* |
| 0x136 | Texture19 | *Unused* | *Unused* | *Unused* |
...
| Param ID | Name | Default Value | Description |
| --- | --- | --- | --- |
| 0xC0 | CustomFloat0 | *Unused* | *Unused* |
| 0xC1 | CustomFloat1 | 1.0 | Ambient occlusion map intensity ([Texture3](https://github.com/ScanMountGoat/Smush-Material-Research/blob/master/Textures.md#ambient-occlusion-maps-texture3)). A value of 0 has full effect. Values higher than 0 increase the intensity of the darkening effect. |
| 0xC2 | CustomFloat2 | *Unused* | *Unused* |
| 0xC3 | CustomFloat3 | *Unused* | *Unused* |
| 0xC4 | CustomFloat4 | 0.0 | Controls the intensity of a UV distortion effect using the normal map. Used for water materials. |
| 0xC5 | CustomFloat5 | *Unused* | *Unused* |
| 0xC6 | CustomFloat6 | | Set to 1 for the pikmin_planet models that use C0. |
| 0xC7 | CustomFloat7 | *Unused* | *Unused* |
| 0xC8 | CustomFloat8 | 0.0 | Controls albedo color tint intensity used for the specular pass. The effect is similar to the tint used for the principled shader. |
| 0xC9 | CustomFloat9 | | ??? |
| 0xCA | CustomFloat10 | 0.0 | Specular anisotropy. A value of 0 produces isotropic specular. |
...
| 0xCD | CustomFloat13 | *Unused* | *Unused* |
| 0xCE | CustomFloat14 | *Unused* | *Unused* |
| 0xCF | CustomFloat15 | *Unused* | *Unused* |
...
| 0xE9 | CustomBoolean1 | True | PRM specular override. True = PRM alpha, False = 0.16 |
| 0xEA | CustomBoolean2 | False | Alpha Override. True = set alpha to 0.0, False = preserve alpha |
| 0xEB | CustomBoolean3 | True | Enables/disables the specular light contribution. True = enabled, False = disabled. |
| 0xEC | CustomBoolean4 | True | Enables/disables the specular cube map contribution. True = enabled, False = disabled. |
...
| 0xF1 | CustomBoolean9 | | Adjusts the effect of CustomVector18. Some shaders ignore CustomBoolean9. When enabled, CustomVector18.z selects the sprite in the texture to use. |
| 0xF2 | CustomBoolean10 | | Set to false for spirits_floor_model\damage for each stage. |
| 0xF3 | CustomBoolean11 | | May effect texture blending of emission textures. Set to false for spirits_floor_model meshes. Used for the sun shaft for fe_siege. |
| 0xF4 | CustomBoolean12 | | Set to true for fe_siege arena. False for ink meshes. |
| 0xF5 | CustomBoolean13 | *Unused* | *Unused* |
| 0xF6 | CustomBoolean14 | *Unused* | *Unused* |
| 0xF7 | CustomBoolean15 | *Unused* | *Unused* |
| 0xF8 | CustomBoolean16 | *Unused* | *Unused* |
| 0xF9 | CustomBoolean17 | *Unused* | *Unused* |
| 0xFA | CustomBoolean18 | *Unused* | *Unused* |
| 0xFB | CustomBoolean19 | *Unused* | *Unused* |
